<template>
	<view class="container">
		...
		<view class="wrapper">
			...
			<button v-if="!loginType" class="confirm-btn" @click="chooseLoginType('phone')" :disabled="logining">手机账号密码登录</button>
			<!-- #ifdef MP-WEIXIN -->
			...
			<view v-if="loginType === 'phone'" class="forget-section" @click="toForget" >
				忘记密码?
			</view>
			<view class="suibian-section" @click="navBack">
				随便看看
			</view>
		</view>
